    ...
    <div className="mb-6 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <form ref={formRef} action={formAction} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-1.5 sm:col-span-2">
          ...
          <input id="name" name="name" required placeholder="Familia García" className={inputClass} />
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input id="contact_name" name="contact_name" placeholder="Opcional" className={inputClass} />
        </div>
