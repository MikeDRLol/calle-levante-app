...
- **Siguiente paso:** módulo Settlements (ADR-007, pendiente de documento — el motor de liquidaciones y reparto de beneficios que hoy vive en Google Apps Script) o cerrar la deuda de Documents (Core según ADR-005, sin tabla propia todavía) — ver `docs/architecture/README.md` para el estado completo de módulos.
